...
// bottom
    ...
    ctx.fillRect(0,Game.DIM_Y - 13,Game.DIM_X, 17);

//right
    ctx.fillStyle = "#D50F25";
    ctx.fillRect(Game.DIM_X - 17,0,21,Game.DIM_Y + 4);

// top
    ctx.fillStyle = "#EEB211";
    ctx.fillRect(0,0,Game.DIM_X + 4, 17);

//left
    ctx.fillStyle =  "#3369E8";
    ctx.fillRect(0,0,17,Game.DIM_Y - 13);
    ...
    ctx.fillRect(8.5, Game.DIM_Y * 3 / 8, 8.5,Game.DIM_Y / 4);
     if (left_map_inverted) {
      ...
      //  path.lineTo(17,299);
      //  path.lineTo(17,323);
      path.moveTo(0, Game.DIM_Y / 2);
      path.lineTo(17, (Game.DIM_Y / 2) - 12);
      path.lineTo(17, (Game.DIM_Y / 2) + 12);
      ctx.fill(path);
     };
    ...
    if (right_map_inverted) {
      ...
      path.moveTo(Game.DIM_X, Game.DIM_Y / 2);
      path.lineTo(Game.DIM_X - 17, (Game.DIM_Y / 2) - 12);
      path.lineTo(Game.DIM_X - 17, (Game.DIM_Y / 2) + 12);
      ctx.fill(path);
    }
    ...
    if (top_map_inverted) {
      ...
      // path.lineTo(613,17);
      // path.lineTo(637,17);
      path.moveTo(Game.DIM_X / 2, 17);
      path.lineTo((Game.DIM_X / 2) - 12, 0);
      path.lineTo((Game.DIM_X / 2) + 12, 0);
      ctx.fill(path);
    };

    ctx.fillStyle = bottom_map_color;
    ctx.fillRect(Game.DIM_X * 3 / 8, Game.DIM_Y - 13, Game.DIM_X / 4, 8.5);
    if (bottom_map_inverted) {
      ...
      // path.lineTo(613,603);
      // path.lineTo(637,603);
      path.moveTo(Game.DIM_X / 2, Game.DIM_Y + 5);
      path.lineTo((Game.DIM_X / 2) - 12,Game.DIM_Y - 13);
      path.lineTo((Game.DIM_X / 2) + 12, Game.DIM_Y - 13);
      ctx.fill(path);
    };
  ...
  if (this.ships[0]) {
    ...
    if (this.countdown) {
      ...
      ctx.fillStyle = "white";
      ctx.font="30px Trebuchet MS";
      ctx.fillText(parseInt(this.countdown), Game.DIM_X / 2, Game.DIM_Y / 2);
